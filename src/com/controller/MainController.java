...
import com.service.BartenderService;
import com.service.CookService;
import com.service.DishwasherService;
...
public class MainController {
    ...
    private DishwasherService dishwasherService = new DishwasherService();
    private CookService cookService = new CookService();
    private BartenderService bartenderService = new BartenderService();
    ...
    private void showCooksList() {
        cookService.printCooks((cookService.getAllCooks()));
    }

    private void showBartendersList() {
        bartenderService.printBartenders(bartenderService.getAllBartenders());
    }

    private void showWaitersList() {
        waiterService.printWaiters(waiterService.getAllWaiters());
    }

    private void showDishwashersList() {
        dishwasherService.printDishwashers(dishwasherService.getAllDishwashers());
    }
